...
export const registerSettingsIpcHandlers = (): void => {
  ...
  ipcMain.handle("get-available-tags", async () => {
    const { getAvailableTags } = await import("./settings");
  ...
  ipcMain.handle(
    ...
    async (_event: IpcMainInvokeEvent, tags: any[]): Promise<SaveResult> => {
      const { setAvailableTags } = await import("./settings");
  ...
  ipcMain.handle(
    ...
    async (
      ...
      const { getCharacterTags } = await import("./settings");
  ...
  ipcMain.handle(
    ...
    async (
      ...
      const { addCharacterTag } = await import("./settings");
  ...
  ipcMain.handle(
    ...
    async (
      ...
      const { removeCharacterTag } = await import("./settings");
  ...
  ipcMain.handle(
    ...
    async (
      ...
      const { createCustomTag } = await import("./settings");
      try {
  ...
  ipcMain.handle(
    ...
    async (_event: IpcMainInvokeEvent, tagId: string): Promise<SaveResult> => {
      const { deleteCustomTag } = await import("./settings");
  ...
  ipcMain.handle("get-all-character-tags", async () => {
    const { getAllCharacterTags } = await import("./settings");
